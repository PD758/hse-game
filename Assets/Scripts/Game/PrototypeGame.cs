...
public sealed class PrototypeGame : MonoBehaviour
{
    ...
    private void CreateOnePixelSprites()
    {
        floorSprite = CreateOnePixelSprite(new Color(0.09f, 0.10f, 0.11f), 1f);
        floorSprites = new[] { floorSprite };
        floorDecalSprites = new[]
        {
            CreateOnePixelSprite(new Color(0.65f, 0.72f, 0.76f, 0.72f), 1f),
            CreateOnePixelSprite(new Color(0.25f, 0.40f, 0.48f, 0.70f), 1f),
            CreateOnePixelSprite(new Color(0.80f, 0.18f, 0.22f, 0.58f), 1f),
        };
        wallSprite = CreateOnePixelSprite(new Color(0.22f, 0.24f, 0.27f), 1f);
        wallVerticalSprite = wallSprite;
        wallCornerSprite = wallSprite;
        plateSprite = CreateOnePixelSprite(new Color(0.28f, 0.25f, 0.18f), 1f);
        pressedPlateSprite = CreateOnePixelSprite(new Color(0.12f, 0.24f, 0.26f), 1f);
        gateSprite = CreateOnePixelSprite(new Color(0.34f, 0.10f, 0.14f), 1f);
        openGateSprite = CreateOnePixelSprite(new Color(0.10f, 0.30f, 0.28f), 1f);
        exitSprite = CreateOnePixelSprite(new Color(0.82f, 0.88f, 0.92f), 1f);
        openExitSprite = exitSprite;
        rubbleSprite = CreateOnePixelSprite(new Color(0.18f, 0.18f, 0.20f), 1f);
        trapSprite = CreateOnePixelSprite(new Color(0.18f, 0.10f, 0.13f), 1f);
        remoteSprite = CreateOnePixelSprite(new Color(0.12f, 0.13f, 0.14f), 1f);
        storySprite = CreateOnePixelSprite(new Color(0.12f, 0.17f, 0.20f), 1f);
        playerSprite = CreateOnePixelSprite(new Color(0.22f, 0.33f, 0.40f), 1f);
        ...
        stoneSprite = CreateOnePixelSprite(new Color(0.39f, 0.33f, 0.27f), 1f);
        enemySprite = CreateOnePixelSprite(new Color(0.34f, 0.12f, 0.16f), 1f);
