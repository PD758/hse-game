...
public sealed partial class PrototypeGame
{
    ...
    private void PersistGeneratedSpritesForEditor()
    {
        ...
        hunterSprite = PersistSpriteForEditor(folder, "hunter_patrol", hunterSprite);
        hunterWalkSprite = PersistSpriteForEditor(folder, "hunter_walk", hunterWalkSprite);
        hunterInvestigateSprite = PersistSpriteForEditor(folder, "hunter_investigate", hunterInvestigateSprite);
        hunterHuntSprite = PersistSpriteForEditor(folder, "hunter_hunt", hunterHuntSprite);
        bruteSprite = PersistSpriteForEditor(folder, "brute_patrol", bruteSprite);
        bruteWalkSprite = PersistSpriteForEditor(folder, "brute_walk", bruteWalkSprite);
        bruteInvestigateSprite = PersistSpriteForEditor(folder, "brute_investigate", bruteInvestigateSprite);
        bruteHuntSprite = PersistSpriteForEditor(folder, "brute_hunt", bruteHuntSprite);
        callerSprite = PersistSpriteForEditor(folder, "caller_patrol", callerSprite);
        callerWalkSprite = PersistSpriteForEditor(folder, "caller_walk", callerWalkSprite);
        callerInvestigateSprite = PersistSpriteForEditor(folder, "caller_investigate", callerInvestigateSprite);
        callerHuntSprite = PersistSpriteForEditor(folder, "caller_hunt", callerHuntSprite);
